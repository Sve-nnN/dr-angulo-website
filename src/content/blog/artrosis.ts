...
export const postArtrosis: BlogPost = {
  ...
  ctaBanner: {
    heading: "¿El dolor articular ya te está limitando el día?",
    body: "Una evaluación con tus estudios define si lo tuyo necesita tratamiento o solo control.",
  },
  intro: [],
  sections: [
    {
    ...
    {
      id: "que-es--que-es-bueno-para-la-artrosis",
      level: 3,
      heading: "Qué es bueno para la artrosis",
      paragraphs: [
    ...
    {
      id: "que-es--artrosis-lumbosacro",
      level: 3,
      heading: "Artrosis lumbosacra",
      paragraphs: [
    ...
    {
      id: "que-es--diferencia-entre-osteoporosis-y-artrosis",
      level: 3,
      heading: "Diferencia entre osteoporosis y artrosis",
      paragraphs: [
    ...
    {
      id: "que-es--artrosis-de-rodilla",
      level: 3,
      heading: "Artrosis de rodilla",
      paragraphs: [
    ...
    {
      id: "que-es--artrosis-mano",
      level: 3,
      heading: "Artrosis en las manos",
      paragraphs: [
    ...
    {
      id: "que-es--artrosis-y-artritis",
      level: 3,
      heading: "Artrosis y artritis",
      paragraphs: [
    ...
    {
      id: "causas--que-es-la-artrosis-y-que-lo-provoca",
      level: 3,
      heading: "¿Qué es la artrosis y qué lo provoca?",
      paragraphs: [
    ...
    {
      id: "causas--que-hacer-para-frenar-la-artrosis",
      level: 3,
      heading: "¿Qué hacer para frenar la artrosis?",
      paragraphs: [
    ...
    {
      id: "causas--como-frenar-la-artrosis",
      level: 3,
      heading: "Cómo frenar la artrosis",
      paragraphs: [
    ...
    {
      id: "sin-operar--que-es-la-artrosis-y-se-cura",
      level: 3,
      heading: "¿Qué es la artrosis y se cura?",
      paragraphs: [
    ...
    {
      id: "sin-operar--pastillas-para-la-artrosis",
      level: 3,
      heading: "Pastillas para la artrosis",
      paragraphs: [
    ...
    {
      id: "preguntas-frecuentes--cual-es-la-mejor-vitamina-para-la-artrosis",
      level: 3,
      heading: "¿Cuál es la mejor vitamina para la artrosis?",
      paragraphs: [
