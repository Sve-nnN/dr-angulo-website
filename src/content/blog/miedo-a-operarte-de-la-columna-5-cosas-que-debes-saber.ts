  ...
  sections: [
    {
      id: "que-es",
      level: 2,
      heading: "Qué es la cirugía de columna",
      paragraphs: [
    ...
    {
      id: "que-es--cirugia-de-la-columna-cervical",
      level: 3,
      heading: "Cirugía de la columna cervical",
      paragraphs: [
    ...
    {
      id: "que-es--cirugia-de-la-columna-escoliosis",
      level: 3,
      heading: "Cirugía de la columna escoliosis",
      paragraphs: [
    ...
    {
      id: "que-es--cirugia-de-la-columna-lumbar",
      level: 3,
      heading: "Cirugía de la columna lumbar",
      paragraphs: [
    ...
    {
      id: "que-es--caminar-despues-de-cirugia-de-columna",
      level: 3,
      heading: "Caminar después de cirugía de columna",
      paragraphs: [
    ...
    {
      id: "que-es--cirugia-de-la-columna-precio",
      level: 3,
      heading: "Cirugía de la columna precio",
      paragraphs: [
    ...
    {
      id: "que-es--secuelas-de-cirugia-de-columna-lumbar",
      level: 3,
      heading: "Secuelas de cirugía de columna lumbar",
      paragraphs: [
    ...
    {
      id: "que-es--cirugia-de-la-columna-lumbar-con-tornillos",
      level: 3,
      heading: "Cirugía de la columna lumbar con tornillos",
      paragraphs: [
    ...
    },
    {
      id: "sintomas",
      level: 2,
      heading: "Qué síntomas ponen la operación sobre la mesa",
      paragraphs: [
    ...
    },
    {
      id: "causas",
      level: 2,
      heading: "Por qué se llega a esta conversación",
      paragraphs: [
    ...
    },
    {
      id: "diagnostico",
      level: 2,
      heading: "Cómo se confirma que hace falta",
      paragraphs: [
    ...
    {
      id: "cirugia--que-tan-riesgosa-es-una-operacion-en-la-columna",
      level: 3,
      heading: "¿Qué tan riesgosa es una operación en la columna?",
      paragraphs: [
    ...
    {
      id: "cirugia--cual-es-el-costo-de-una-operacion-de-columna",
      level: 3,
      heading: "¿Cuál es el costo de una operación de columna?",
      paragraphs: [
    ...
    {
      id: "cirugia--como-dormir-despues-de-una-cirugia-de-columna",
      level: 3,
      heading: "Como dormir después de una cirugía de columna",
      paragraphs: [
    ...
    {
      id: "preguntas-frecuentes--cuanto-tiempo-tarda-en-recuperarse-de-una-cirugia-de-columna",
      level: 3,
      heading: "¿Cuánto tiempo tarda en recuperarse de una cirugía de columna?",
      paragraphs: [
    ...
    {
      id: "preguntas-frecuentes--cuales-son-las-cirugias-de-columna",
      level: 3,
      heading: "¿Cuáles son las cirugías de columna?",
      paragraphs: [
