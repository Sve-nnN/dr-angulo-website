...
export const escoliosisYDeformidades: ServicePage = {
  ...
  sections: [
    ...
    {
      id: "tratamiento--manejo-conservador",
      level: 3,
    ...
    {
      id: "tratamiento--cuando-se-plantea-la-cirugia",
      level: 3,
    ...
    {
      id: "preguntas-frecuentes--la-mochila-del-colegio-produce-escoliosis",
      level: 3,
    ...
    {
      id: "preguntas-frecuentes--la-escoliosis-se-corrige-con-ejercicios",
      level: 3,
    ...
    {
      id: "preguntas-frecuentes--puede-hacer-deporte-con-escoliosis",
      level: 3,
    ...
    {
      id: "preguntas-frecuentes--se-pierde-movimiento-despues-de-una-artrodesis",
      level: 3,
