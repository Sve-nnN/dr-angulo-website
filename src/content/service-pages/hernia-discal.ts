...
export const herniaDiscal: ServicePage = {
  slug: "hernia-discal",
  ...
  // El bloque de señales de alarma sumó cuerpo al cierre y corrió el banner
  // fuera de la ventana de POS-01: detrás de `que-es` cae en el 14 por ciento
  // y detrás de `sintomas` en el 35, los dos bordes. Ninguna frontera de nivel
  // 2 queda dentro, así que la posición pasa a un id de nivel 3, que es para lo
  // que el campo admite nivel 3. Detrás de la lista de síntomas el lector acaba
  // de reconocer el dolor que baja por la pierna, que es lo que pregunta el
  // banner.
  ...
  sections: [
    {
      id: "que-es",
      level: 2,
      heading: "Qué es la hernia discal",
      paragraphs: [
    ...
    {
      id: "que-es--que-pasa-cuando-una-persona-tiene-una-hernia-discal",
      level: 3,
      heading: "¿Qué pasa cuando una persona tiene una hernia discal?",
      paragraphs: [
    ...
    {
      id: "que-es--hernia-discal-lumbar-y-cervical",
      level: 3,
      heading: "Hernia discal lumbar y cervical",
      paragraphs: [
    ...
    {
      id: "sintomas--cuales-son-los-sintomas-de-una-hernia-de-disco",
      level: 3,
      heading: "¿Cuáles son los síntomas de una hernia de disco?",
      paragraphs: [
    ...
    {
      id: "sintomas--diferencia-entre-ciatica-y-hernia-discal",
      level: 3,
      heading: "Diferencia entre ciática y hernia discal",
      paragraphs: [
    ...
    {
      id: "sintomas--diferencia-entre-lumbalgia-y-hernia-discal",
      level: 3,
      heading: "Diferencia entre lumbalgia y hernia discal",
      paragraphs: [
    ...
    {
      id: "sintomas--sintomas-de-la-hernia-discal-lumbar",
      level: 3,
      heading: "Síntomas de la hernia discal lumbar",
      paragraphs: [
    ...
    {
      id: "diagnostico--hernia-discal-en-la-tomografia",
      level: 3,
      heading: "Hernia discal en la tomografía",
      paragraphs: [
    ...
    {
      id: "sin-operar--como-se-cura-la-hernia-discal",
      level: 3,
      heading: "¿Cómo se cura la hernia discal?",
      paragraphs: [
    ...
    {
      id: "sin-operar--tratamiento-de-la-hernia-discal-lumbosacra",
      level: 3,
      heading: "Tratamiento de la hernia discal lumbosacra",
      paragraphs: [
    ...
    {
      id: "sin-operar--como-desinflamar-hernia-discal",
      level: 3,
      heading: "Cómo desinflamar una hernia discal",
      paragraphs: [
    ...
    {
      id: "sin-operar--medicamento-para-desinflamar-hernia-discal",
      level: 3,
      heading: "Medicamento para desinflamar una hernia discal",
      paragraphs: [
    ...
    {
      id: "preguntas-frecuentes--que-no-se-debe-hacer-cuando-tienes-hernia-discal",
      level: 3,
      heading: "¿Qué no se debe hacer cuando tienes hernia discal?",
      paragraphs: [
