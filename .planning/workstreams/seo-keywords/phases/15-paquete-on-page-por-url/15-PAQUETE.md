...
| `/blog/miedo-a-operarte-de-la-columna-5-cosas-que-debes-saber` | reescribir | guía clínica | [`paquetes/blog-miedo-a-operarte-de-la-columna-5-cosas-que-debes-saber.md`](paquetes/blog-miedo-a-operarte-de-la-columna-5-cosas-que-debes-saber.md) | 1497 / mínimo 900 |
| `/contacto` | dejar | documento corto | [`paquetes/contacto.md`](paquetes/contacto.md) | sin cuerpo |
| `/preguntas-frecuentes` | reescribir | guía clínica | [`paquetes/preguntas-frecuentes.md`](paquetes/preguntas-frecuentes.md) | 1828 / mínimo 800 |
...
| `/testimonios` | dejar | documento corto | [`paquetes/testimonios.md`](paquetes/testimonios.md) | sin cuerpo |

## Qué recibe cada grupo

| Grupo | Cuántas | Qué recibe |
| --- | --- | --- |
| Con keyword primaria | 16 | Página completa: title, meta, H1, jerarquía, entidades obligatorias y copy redactado para pegar. |
| Declararon no competir | 6 | Title y meta nuevos, el H1 publicado sin tocar, y el motivo escrito de por qué no pelean ninguna keyword (D-06). |
| Se apagan con un 301 | 2 | La instrucción de redirección y la lista de qué bloque suyo quedó en qué sección de la guía de destino (D-07). |
