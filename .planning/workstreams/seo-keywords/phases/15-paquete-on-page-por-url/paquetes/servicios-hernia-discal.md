...
| Keyword primaria | `hernia discal` |
| Mínimo de palabras | 1400 |
| Palabras redactadas | 2483 (mínimo 1400) |
...
| --- | --- | --- |
| Title | Hernia discal: síntomas, diagnóstico y tratamiento | 50 / 60 |
| Meta description | Qué es una hernia discal, qué síntomas produce, cómo se confirma con resonancia y en qué casos se plantea la cirugía. Guía de columna en Lima. | 142 / 155 |
| H1 | Hernia discal | sin límite |

Por qué ese H1: La keyword primaria va literal y sola. La SERP de Lima premia contenido informativo para esta búsqueda, y el título que mejor responde a alguien que escribe hernia discal es el nombre de lo que le pasa, sin adorno comercial delante.

## Jerarquía de encabezados

| Nivel | Encabezado | De dónde sale |
| --- | --- | --- |
| H2 | **Qué es la hernia discal** | esqueleto |
| H3 | &nbsp;&nbsp;¿Qué pasa cuando una persona tiene una hernia discal? | pregunta-serp: `¿Qué pasa cuando una persona tiene una hernia discal?` |
| H3 | &nbsp;&nbsp;Hernia discal lumbar y cervical | secundaria-del-mapa: `hernia discal lumbar y cervical` |
| H2 | **Qué síntomas produce** | esqueleto |
| H3 | &nbsp;&nbsp;¿Cuáles son los síntomas de una hernia de disco? | pregunta-serp: `¿Cuáles son los síntomas de una hernia de disco?` |
| H3 | &nbsp;&nbsp;Diferencia entre ciática y hernia discal | secundaria-del-mapa: `ciatica o hernia discal` |
| H3 | &nbsp;&nbsp;Diferencia entre lumbalgia y hernia discal | secundaria-del-mapa: `lumbalgia o hernia discal` |
| H3 | &nbsp;&nbsp;Síntomas de la hernia discal lumbar | busqueda-relacionada: `Hernia discal lumbar síntomas` |
| H2 | **Por qué aparece** | esqueleto |
| H2 | **Cómo se confirma el diagnóstico** | esqueleto |
| H3 | &nbsp;&nbsp;Hernia discal en la tomografía | secundaria-del-mapa: `hernia discal tomografía` |
| H2 | **Qué se puede hacer sin operar** | esqueleto |
| H3 | &nbsp;&nbsp;¿Cómo se cura la hernia discal? | pregunta-serp: `¿Cómo se cura la hernia discal?` |
| H3 | &nbsp;&nbsp;Tratamiento de la hernia discal lumbosacra | secundaria-del-mapa: `hernia discal lumbosacra tratamiento` |
| H3 | &nbsp;&nbsp;Cómo desinflamar una hernia discal | busqueda-relacionada: `Como desinflamar hernia discal` |
| H3 | &nbsp;&nbsp;Medicamento para desinflamar una hernia discal | busqueda-relacionada: `Medicamento para desinflamar hernia discal` |
| H2 | **Cuándo hace falta operar** | esqueleto |
| H2 | **Preguntas frecuentes** | esqueleto |
| H3 | &nbsp;&nbsp;¿Qué no se debe hacer cuando tienes hernia discal? | pregunta-serp: `¿Qué no se debe hacer cuando tienes hernia discal?` |
...
| --- | --- |
| `hernia discal lumbar y cervical` | Hernia discal lumbar y cervical |
| `hernia discal lumbosacra tratamiento` | Tratamiento de la hernia discal lumbosacra |
| `ciatica o hernia discal` | Diferencia entre ciatica y hernia discal |
| `hernia discal tomografía` | Hernia discal en la tomografía |
| `lumbalgia o hernia discal` | Diferencia entre lumbalgia y hernia discal |

### Cobertura de las búsquedas relacionadas

| Búsqueda relacionada | Encabezado que la cubre |
| --- | --- |
| `Como desinflamar hernia discal` | Como desinflamar hernia discal |
| `Hernia discal lumbar` | Hernia discal lumbar y cervical |
| `Hernia discal tratamiento` | Tratamiento de la hernia discal lumbosacra |
| `Hernia discal síntomas` | Qué síntomas produce |
| `Hernia discal: síntomas graves` | Qué síntomas produce |
| `Hernia discal lumbar síntomas` | Síntomas de la hernia discal lumbar |
| `Hernia discal causas` | Por qué aparece |
| `Medicamento para desinflamar hernia discal` | Medicamento para desinflamar hernia discal |

## Entidades obligatorias

Derivadas de los títulos y fragmentos de los 7 orgánicos que ya
posicionan para `hernia discal`, con umbral de frecuencia documental
...
| --- | --- | --- | --- |
| `hernia` | 7 de 7 | 1, 2, 3, 4, 5, 6, 7 | clinica |
| `discal` | 6 de 7 | 2, 3, 4, 5, 6, 7 | clinica |
| `hernia discal` | 5 de 7 | 2, 3, 4, 5, 6 | clinica |
| `disco` | 4 de 7 | 1, 2, 4, 7 | anatomica |
| `desplaza` | 3 de 7 | 1, 4, 5 | generica |
| `lumbar` | 3 de 7 | 3, 6, 7 | anatomica |
| `causas` | 2 de 7 | 1, 6 | generica |
| `sintomas` | 2 de 7 | 1, 4 | clinica |
| `columna` | 2 de 7 | 2, 5 | anatomica |
| `discal lumbar` | 2 de 7 | 3, 6 | clinica |
| `hernia discal lumbar` | 2 de 7 | 3, 6 | clinica |
| `nucleo` | 2 de 7 | 3, 4 | anatomica |
| `nucleo pulposo` | 2 de 7 | 3, 4 | anatomica |
| `pulposo` | 2 de 7 | 3, 4 | anatomica |

## Copy propuesto

Redactado para pegar. 2483 palabras de prosa contra un mínimo de
...
La revisión de esta URL entra completa en una sola pasada. Lo que más necesita ojo clínico está concentrado en cuatro bloques: la sección de síntomas, porque es la que un paciente usa para autoevaluarse; la de diagnóstico, por la frase sobre resonancias alteradas en gente sin dolor; la de tratamiento sin operar, por la mención de infiltraciones y por el párrafo de medicamentos, donde a propósito no se nombra ningún principio activo ni dosis; y la de cuándo consultar, por las tres banderas rojas. Lo demás se lee rápido. No hay ninguna cifra de cirugías, ninguna tasa de éxito ni ninguna credencial en el texto, y esa ausencia es deliberada.
...
| --- | --- | --- | --- |
| Qué es la hernia discal | clinico | pendiente-doctor | 0 |
| ¿Qué pasa cuando una persona tiene una hernia discal? | clinico | pendiente-doctor | 0 |
| Hernia discal lumbar y cervical | clinico | pendiente-doctor | 0 |
| Qué síntomas produce | clinico | pendiente-doctor | 0 |
| ¿Cuáles son los síntomas de una hernia de disco? | clinico | pendiente-doctor | 0 |
| Diferencia entre ciática y hernia discal | clinico | pendiente-doctor | 0 |
| Diferencia entre lumbalgia y hernia discal | clinico | pendiente-doctor | 0 |
| Síntomas de la hernia discal lumbar | clinico | pendiente-doctor | 0 |
| Por qué aparece | clinico | pendiente-doctor | 0 |
| Cómo se confirma el diagnóstico | clinico | pendiente-doctor | 0 |
| Hernia discal en la tomografía | clinico | pendiente-doctor | 0 |
| Qué se puede hacer sin operar | clinico | pendiente-doctor | 0 |
| ¿Cómo se cura la hernia discal? | clinico | pendiente-doctor | 0 |
| Tratamiento de la hernia discal lumbosacra | clinico | pendiente-doctor | 0 |
| Cómo desinflamar una hernia discal | clinico | pendiente-doctor | 0 |
| Medicamento para desinflamar una hernia discal | clinico | pendiente-doctor | 0 |
| Cuándo hace falta operar | clinico | pendiente-doctor | 0 |
| Preguntas frecuentes | clinico | pendiente-doctor | 0 |
| ¿Qué no se debe hacer cuando tienes hernia discal? | clinico | pendiente-doctor | 0 |
