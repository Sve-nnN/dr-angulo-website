...
La SERP de `artrosis` pide guía clínica y el esqueleto es el mismo de las guías de servicio, pero este es un post de captación y el límite se sostiene en el contenido: explica la condición desde donde la vive el paciente y deriva. El tratamiento en detalle y la decisión quirúrgica viven en las páginas de servicio, no acá.

## Title, meta y H1

| Campo | Texto | Caracteres |
| --- | --- | --- |
| Title | Artrosis: qué es, cómo se trata y cuándo consultar | 50 / 60 |
| Meta description | Qué es la artrosis, en qué articulaciones aparece, qué frena su avance y cuándo conviene consultar con un traumatólogo en Lima. | 127 / 155 |
| H1 | Artrosis: el desgaste de la articulación | sin límite |

Por qué ese H1: El title enumera lo que la página cubre y el H1 define la condición en cinco palabras, que es lo que hace falta antes de leer el resto.

## Jerarquía de encabezados

| Nivel | Encabezado | De dónde sale |
| --- | --- | --- |
| H2 | **Qué es la artrosis** | esqueleto |
| H3 | &nbsp;&nbsp;Qué es bueno para la artrosis | secundaria-del-mapa: `que es bueno para la artrosis` |
| H3 | &nbsp;&nbsp;Artrosis lumbosacra | secundaria-del-mapa: `artrosis lumbosacro` |
| H3 | &nbsp;&nbsp;Diferencia entre osteoporosis y artrosis | secundaria-del-mapa: `osteoporosis o artrosis` |
| H3 | &nbsp;&nbsp;Artrosis de rodilla | busqueda-relacionada: `Artrosis de rodilla` |
| H3 | &nbsp;&nbsp;Artrosis en las manos | busqueda-relacionada: `Artrosis mano` |
| H3 | &nbsp;&nbsp;Artrosis y artritis | busqueda-relacionada: `Artrosis y artritis` |
| H2 | **Qué síntomas produce** | esqueleto |
| H2 | **Por qué aparece** | esqueleto |
| H3 | &nbsp;&nbsp;¿Qué es la artrosis y qué lo provoca? | pregunta-serp: `¿Qué es la artrosis y qué lo provoca?` |
| H3 | &nbsp;&nbsp;¿Qué hacer para frenar la artrosis? | pregunta-serp: `¿Qué hacer para frenar la artrosis?` |
| H3 | &nbsp;&nbsp;Cómo frenar la artrosis | secundaria-del-mapa: `como frenar la artrosis` |
| H2 | **Cómo se confirma el diagnóstico** | esqueleto |
| H2 | **Qué se puede hacer sin operar** | esqueleto |
| H3 | &nbsp;&nbsp;¿Qué es la artrosis y se cura? | pregunta-serp: `¿Qué es la artrosis y se cura?` |
| H3 | &nbsp;&nbsp;Pastillas para la artrosis | secundaria-del-mapa: `pastillas para la artrosis` |
| H2 | **Cuándo hace falta operar** | esqueleto |
| H2 | **Preguntas frecuentes** | esqueleto |
| H3 | &nbsp;&nbsp;¿Cuál es la mejor vitamina para la artrosis? | pregunta-serp: `¿Cuál es la mejor vitamina para la artrosis?` |
...
| --- | --- |
| `que es bueno para la artrosis` | Que es bueno para la artrosis |
| `artrosis lumbosacro` | Artrosis lumbosacro |
| `como frenar la artrosis` | Como frenar la artrosis |
| `pastillas para la artrosis` | Pastillas para la artrosis |
| `osteoporosis o artrosis` | Diferencia entre osteoporosis y artrosis |
...
| --- | --- |
| `Como frenar la artrosis` | Como frenar la artrosis |
| `Artrosis de rodilla` | Artrosis de rodilla |
| `Artrosis causas` | Por qué aparece |
| `Artrosis mano` | Artrosis mano |
| `Artrosis síntomas` | Qué síntomas produce |
| `Artrosis y artritis` | Artrosis y artritis |
| `Tipos de artrosis` | Qué es la artrosis |
| `Artrosis PDF` | Qué es la artrosis |

## Entidades obligatorias

Derivadas de los títulos y fragmentos de los 7 orgánicos que ya
posicionan para `artrosis`, con umbral de frecuencia documental
...
| `rigidez` | 3 de 7 | 1, 3, 4 | clinica |
| `afecta` | 3 de 7 | 3, 6, 7 | generica |
| `articulaciones` | 3 de 7 | 4, 5, 7 | anatomica |
...
| --- | --- |
| `slug` | `artrosis`, la ruta publicada sin el prefijo /blog/. No cambia: la URL se conserva. |
...
| `relatedService` | `hernia-discal`. Es el servicio de columna al que el blog empuja hoy en las cuatro entradas. Si v1.1 publica una guía de columna más cercana al desgaste, esta es la fila que cambia. |
| `ctaBanner.heading` | ¿El dolor articular ya te está limitando el día? |
| `ctaBanner.body` | Una evaluación con tus estudios define si lo tuyo necesita tratamiento o solo control. |
| `intro` | Los dos primeros párrafos de la sección `que-es`, que son los que responden qué es la artrosis antes de cualquier encabezado. |
...
| --- | --- | --- | --- |
| 1 | `/blog/5-sintomas-de-columna-que-no-debes-ignorar` | ciática o lumbalgia | vecindad-tematica |
| 2 | `/blog/lumbalgia` | lumbalgia se opera | vecindad-tematica |
| 3 | `/blog/miedo-a-operarte-de-la-columna-5-cosas-que-debes-saber` | cirugía de columna cervical | vecindad-tematica |
| 4 | `/blog` | Blog | navegacion-de-seccion |
| 5 | `/servicios` | cirujano de columna lima | navegacion-de-seccion |

## Qué queda pendiente del doctor

La revisión de esta URL entra completa en una sola pasada. Lo que más necesita ojo clínico está en cinco bloques: la sección de qué es la artrosis, por la definición de enfermedad degenerativa y la descripción del cartílago; la diferencia entre osteoporosis y artrosis, que es la confusión más repetida en consulta y la que peor sale si queda mal escrita; la comparación entre artrosis y artritis, por el criterio de la rigidez matinal; el bloque de pastillas, donde a propósito no se nombra ningún principio activo ni ninguna dosis; y el de cuándo consultar, por las señales de alarma. Lo demás se lee rápido. No hay ninguna cifra sobre el doctor, ninguna tasa de resultado ni ninguna credencial en el texto, y esa ausencia es deliberada.
...
| --- | --- | --- | --- |
| Qué es la artrosis | clinico | pendiente-doctor | 0 |
| Qué es bueno para la artrosis | clinico | pendiente-doctor | 0 |
| Artrosis lumbosacra | clinico | pendiente-doctor | 0 |
| Diferencia entre osteoporosis y artrosis | clinico | pendiente-doctor | 0 |
| Artrosis de rodilla | clinico | pendiente-doctor | 0 |
| Artrosis en las manos | clinico | pendiente-doctor | 0 |
| Artrosis y artritis | clinico | pendiente-doctor | 0 |
| Qué síntomas produce | clinico | pendiente-doctor | 0 |
| Por qué aparece | clinico | pendiente-doctor | 0 |
| ¿Qué es la artrosis y qué lo provoca? | clinico | pendiente-doctor | 0 |
| ¿Qué hacer para frenar la artrosis? | clinico | pendiente-doctor | 0 |
| Cómo frenar la artrosis | clinico | pendiente-doctor | 0 |
| Cómo se confirma el diagnóstico | clinico | pendiente-doctor | 0 |
| Qué se puede hacer sin operar | clinico | pendiente-doctor | 0 |
| ¿Qué es la artrosis y se cura? | clinico | pendiente-doctor | 0 |
| Pastillas para la artrosis | clinico | pendiente-doctor | 0 |
| Cuándo hace falta operar | clinico | pendiente-doctor | 0 |
| Preguntas frecuentes | clinico | pendiente-doctor | 0 |
| ¿Cuál es la mejor vitamina para la artrosis? | clinico | pendiente-doctor | 0 |
