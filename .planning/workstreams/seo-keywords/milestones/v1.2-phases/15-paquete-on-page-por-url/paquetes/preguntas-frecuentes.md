# Paquete on-page: /preguntas-frecuentes
...
| Keyword primaria | `reumatólogo o traumatólogo` |
| Mínimo de palabras | 800 |
| Palabras redactadas | 1828 (mínimo 800) |
...
| --- | --- | --- |
| Title | Reumatólogo o traumatólogo: a cuál te toca ir | 45 / 60 |
| Meta description | Cuándo corresponde un reumatólogo y cuándo un traumatólogo, qué pasa en la primera cita y en qué casos se plantea operar. | 121 / 155 |
| H1 | Dudas frecuentes antes de la consulta | sin límite |

Por qué ese H1: El title sirve la búsqueda concreta que trae a la gente y el H1 abre el listado entero, que es lo que la página realmente es.

## Jerarquía de encabezados

| Nivel | Encabezado | De dónde sale |
| --- | --- | --- |
| H2 | **Qué es el reumatólogo o traumatólogo** | esqueleto |
| H3 | &nbsp;&nbsp;Diferencia entre artrosis traumatologo y reumatologo | secundaria-del-mapa: `artrosis traumatologo o reumatologo` |
| H3 | &nbsp;&nbsp;Traumatólogo y reumatólogo es lo mismo | secundaria-del-mapa: `traumatólogo y reumatólogo es lo mismo` |
...
| H3 | &nbsp;&nbsp;¿Qué diferencia hay entre un traumatólogo y un reumatólogo? | pregunta-serp: `¿Qué diferencia hay entre un traumatólogo y un reumatólogo?` |
| H3 | &nbsp;&nbsp;¿Cuándo ir al traumatólogo o al reumatólogo? | pregunta-serp: `¿Cuándo ir al traumatólogo o al reumatólogo?` |
| H3 | &nbsp;&nbsp;¿Qué enfermedades trata un reumatólogo? | pregunta-serp: `¿Qué enfermedades trata un reumatólogo?` |
| H3 | &nbsp;&nbsp;¿Qué enfermedades ve el traumatólogo? | pregunta-serp: `¿Qué enfermedades ve el traumatólogo?` |
| H2 | **Cuándo consultar** | esqueleto |
| H3 | &nbsp;&nbsp;Como se llama el médico especialista en huesos articulaciones y músculos | busqueda-relacionada: `Como se llama el médico especialista en huesos articulaciones y músculos` |
| H3 | &nbsp;&nbsp;Reumatólogo especialista en artrosis | busqueda-relacionada: `Reumatólogo especialista en artrosis` |
| H3 | &nbsp;&nbsp;Médico especialista en dolores musculares | busqueda-relacionada: `Médico especialista en dolores musculares` |
| H3 | &nbsp;&nbsp;Especialista en tendones y nervios | busqueda-relacionada: `Especialista en tendones y nervios` |
| H3 | &nbsp;&nbsp;Cuando acudir al traumatólogo | busqueda-relacionada: `Cuando acudir al traumatólogo` |
...
| --- | --- |
| `artrosis traumatologo o reumatologo` | Diferencia entre artrosis traumatologo y reumatologo |
| `cuando ir al traumatólogo o al reumatólogo` | Cuándo hace falta operar |
| `traumatólogo y reumatólogo es lo mismo` | Traumatólogo y reumatólogo es lo mismo |

### Cobertura de las búsquedas relacionadas

| Búsqueda relacionada | Encabezado que la cubre |
| --- | --- |
| `Cuando ir al reumatólogo` | Cuándo hace falta operar |
| `Como se llama el médico especialista en huesos articulaciones y músculos` | Como se llama el médico especialista en huesos articulaciones y músculos |
| `Reumatólogo que trata` | ¿Qué enfermedades trata un reumatólogo? |
| `Reumatólogo` | Qué es el reumatólogo o traumatólogo |
| `Reumatólogo especialista en artrosis` | Reumatólogo especialista en artrosis |
| `Médico especialista en dolores musculares` | Médico especialista en dolores musculares |
| `Especialista en tendones y nervios` | Especialista en tendones y nervios |
| `Cuando acudir al traumatólogo` | Cuando acudir al traumatólogo |

## Entidades obligatorias

Derivadas de los títulos y fragmentos de los 7 orgánicos que ya
posicionan para `reumatólogo o traumatólogo`, con umbral de frecuencia documental
...
| `reumatologo es el medico` | 2 de 7 | 3, 4 | generica |
| `sencilla` | 2 de 7 | 3, 4 | generica |
| `sencilla el reumatologo` | 2 de 7 | 3, 4 | generica |
...
Redactado para pegar. 1828 palabras de prosa contra un mínimo de
800. Todo bloque clínico va sellado y ninguno se publica sin la
aprobación del doctor.

<!-- copy:inicio -->

## Qué es el reumatólogo o traumatólogo
...
### Diferencia entre artrosis traumatologo y reumatologo
...
### Traumatólogo y reumatólogo es lo mismo
...
### Reumatólogo especialista en artrosis
...
### Médico especialista en dolores musculares
...
### Especialista en tendones y nervios
...
Esta página no explica ninguna condición: responde lo transversal, o sea a quién consultar, cómo es la primera cita, qué llevar, cómo se decide operar y qué pasa después. Lo que más necesita ojo clínico es el reparto de competencias entre reumatólogo y traumatólogo, porque es una distinción que se simplifica fácil y quedaría publicada como si fuera una regla rígida. Conviene mirar también la sección de cuándo consultar, por las banderas rojas, y la de qué pasa en la primera cita, por lo que se promete sobre tiempos y estudios. Cada respuesta que toca una condición concreta remite a su guía en vez de desarrollarla, y eso es deliberado: si esta página desarrolla temario clínico compite contra las guías, que es justo lo que la fase 14 se pasó tres planes evitando.
...
| --- | --- | --- | --- |
| Qué es el reumatólogo o traumatólogo | clinico | pendiente-doctor | 0 |
| Diferencia entre artrosis traumatologo y reumatologo | clinico | pendiente-doctor | 0 |
| Traumatólogo y reumatólogo es lo mismo | clinico | pendiente-doctor | 0 |
...
| ¿Qué diferencia hay entre un traumatólogo y un reumatólogo? | clinico | pendiente-doctor | 0 |
| ¿Cuándo ir al traumatólogo o al reumatólogo? | clinico | pendiente-doctor | 0 |
| ¿Qué enfermedades trata un reumatólogo? | clinico | pendiente-doctor | 0 |
| ¿Qué enfermedades ve el traumatólogo? | clinico | pendiente-doctor | 0 |
| Cuándo consultar | clinico | pendiente-doctor | 2 |
| Como se llama el médico especialista en huesos articulaciones y músculos | clinico | pendiente-doctor | 0 |
| Reumatólogo especialista en artrosis | clinico | pendiente-doctor | 0 |
| Médico especialista en dolores musculares | clinico | pendiente-doctor | 0 |
| Especialista en tendones y nervios | clinico | pendiente-doctor | 0 |
| Cuando acudir al traumatólogo | clinico | pendiente-doctor | 0 |
