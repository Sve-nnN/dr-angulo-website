# Paquete on-page: /servicios/escoliosis-y-deformidades
...
| Keyword primaria | `escoliosis` |
| Mínimo de palabras | 1200 |
| Palabras redactadas | 2338 (mínimo 1200) |
...
| --- | --- | --- |
| Title | Escoliosis: cómo se evalúa y cómo se trata | 42 / 60 |
| Meta description | Qué es la escoliosis, cómo se mide la curva, qué opciones hay según la edad y en qué casos se plantea la cirugía. Consulta en Lima. | 131 / 155 |
| H1 | Escoliosis y deformidades de la columna | sin límite |

Por qué ese H1: El H1 abarca lo que la URL cubre después del renombrado, y el title se queda con la búsqueda que la trae, que es la escoliosis sola.

## Jerarquía de encabezados

| Nivel | Encabezado | De dónde sale |
| --- | --- | --- |
| H2 | **Qué es la escoliosis** | esqueleto |
| H3 | &nbsp;&nbsp;Escoliosis y deformidades de columna | secundaria-del-mapa: `escoliosis y deformidades de columna` |
| H3 | &nbsp;&nbsp;Escoliosis dorsal | secundaria-del-mapa: `escoliosis dorsal` |
| H3 | &nbsp;&nbsp;Escoliosis lumbar | secundaria-del-mapa: `escoliosis lumbar` |
| H3 | &nbsp;&nbsp;Escoliosis leve | busqueda-relacionada: `Escoliosis leve` |
| H3 | &nbsp;&nbsp;Se puede corregir la escoliosis en adultos | busqueda-relacionada: `Se puede corregir la escoliosis en adultos` |
| H2 | **Qué síntomas produce** | esqueleto |
| H2 | **Por qué aparece** | esqueleto |
| H3 | &nbsp;&nbsp;¿Qué es la escoliosis y qué lo causa? | pregunta-serp: `¿Qué es la escoliosis y qué lo causa?` |
| H2 | **Cómo se confirma el diagnóstico** | esqueleto |
| H2 | **Qué se puede hacer sin operar** | esqueleto |
| H3 | &nbsp;&nbsp;Ejercicios para la escoliosis | secundaria-del-mapa: `ejercicios para escoliosis` |
| H2 | **Cuándo hace falta operar** | esqueleto |
| H3 | &nbsp;&nbsp;Cirugía de la escoliosis | secundaria-del-mapa: `cirugía de escoliosis` |
| H2 | **Preguntas frecuentes** | esqueleto |
| H3 | &nbsp;&nbsp;¿Cómo se corrige la escoliosis? | pregunta-serp: `¿Cómo se corrige la escoliosis?` |
| H3 | &nbsp;&nbsp;¿Qué se debe hacer si tienes escoliosis? | pregunta-serp: `¿Qué se debe hacer si tienes escoliosis?` |
| H3 | &nbsp;&nbsp;¿Qué no se debe hacer cuando tienes escoliosis? | pregunta-serp: `¿Qué no se debe hacer cuando tienes escoliosis?` |
...
| --- | --- |
| `escoliosis y deformidades de columna` | Escoliosis y deformidades de columna |
| `ejercicios para escoliosis` | Ejercicios para la escoliosis |
| `cirugía de escoliosis` | Cirugía de la escoliosis |
| `escoliosis dorsal` | Escoliosis dorsal |
...
| --- | --- |
| `Escoliosis lumbar` | Escoliosis lumbar |
| `Escoliosis tratamiento` | Qué se puede hacer sin operar |
| `Escoliosis dorsal` | Escoliosis dorsal |
| `Escoliosis leve` | Escoliosis leve |
| `Escoliosis síntomas` | Qué síntomas produce |
| `Se puede corregir la escoliosis en adultos` | Se puede corregir la escoliosis en adultos |
| `Escoliosis ejercicios` | Ejercicios para la escoliosis |
| `Escoliosis causas` | Por qué aparece |

## Entidades obligatorias

Derivadas de los títulos y fragmentos de los 7 orgánicos que ya
posicionan para `escoliosis`, con umbral de frecuencia documental
...
| `escoliosis` | 7 de 7 | 1, 2, 3, 4, 5, 6, 7 | clinica |
| `columna vertebral` | 5 de 7 | 2, 4, 5, 6, 7 | anatomica |
| `vertebral` | 5 de 7 | 2, 4, 5, 6, 7 | anatomica |
...
Redactado para pegar. 2338 palabras de prosa contra un mínimo de
1200. Todo bloque clínico va sellado y ninguno se publica sin la
...
### ¿Qué es la escoliosis y qué lo causa?
...
### ¿Qué se debe hacer si tienes escoliosis?
...
### ¿Qué no se debe hacer cuando tienes escoliosis?
...
La revisión de esta URL entra completa en una sola pasada. Tres bloques concentran lo que más necesita ojo clínico: la sección de qué es, por la cifra de los grados que define el diagnóstico y por la descripción de la cifosis; la de qué se puede hacer sin operar, por lo que se dice del corsé y de hasta dónde llega la terapia; y la de cuándo hace falta operar, por la lista de escenarios. La sección de qué no hacer también conviene leerla despacio, porque es la que desmiente creencias instaladas y una frase de más ahí se cita fuera de contexto. El texto cubre el paraguas completo del slug renombrado, así que nombra cifosis y deformidades del adulto además de escoliosis: si el doctor prefiere acotar el alcance, ese cambio afecta al mapa de keywords y no solo a esta página. No hay cifras de cirugías, tasas de éxito ni credenciales, y esa ausencia es deliberada.
...
| --- | --- | --- | --- |
| Qué es la escoliosis | clinico | pendiente-doctor | 1 |
| Escoliosis y deformidades de columna | clinico | pendiente-doctor | 0 |
| Escoliosis dorsal | clinico | pendiente-doctor | 0 |
| Escoliosis lumbar | clinico | pendiente-doctor | 0 |
| Escoliosis leve | clinico | pendiente-doctor | 0 |
| Se puede corregir la escoliosis en adultos | clinico | pendiente-doctor | 0 |
| Qué síntomas produce | clinico | pendiente-doctor | 0 |
| Por qué aparece | clinico | pendiente-doctor | 0 |
| ¿Qué es la escoliosis y qué lo causa? | clinico | pendiente-doctor | 0 |
| Cómo se confirma el diagnóstico | clinico | pendiente-doctor | 0 |
| Qué se puede hacer sin operar | clinico | pendiente-doctor | 0 |
| Ejercicios para la escoliosis | clinico | pendiente-doctor | 0 |
| Cuándo hace falta operar | clinico | pendiente-doctor | 0 |
| Cirugía de la escoliosis | clinico | pendiente-doctor | 0 |
| Preguntas frecuentes | clinico | pendiente-doctor | 0 |
| ¿Cómo se corrige la escoliosis? | clinico | pendiente-doctor | 0 |
| ¿Qué se debe hacer si tienes escoliosis? | clinico | pendiente-doctor | 0 |
| ¿Qué no se debe hacer cuando tienes escoliosis? | clinico | pendiente-doctor | 0 |
| Cuándo consultar | clinico | pendiente-doctor | 1 |
