...
- [ ] **Phase 17: Indexación y enlaces de entrada** - Rastreo solicitado sobre URLs ya estables, más enlaces externos y entradas de GBP hacia páginas internas. Material preparado en `docs/indexacion-y-enlaces.md`; la ejecución es manual y de Juan
- [~] **Phase 18: Rendimiento y accesibilidad** - `/testimonios`, imagen LCP, bundle, los tres fallos de accesibilidad y la tarjeta de Open Graph, cerrados. Falta solo CWV-01: la regla de caché de borde está escrita y espera el panel de Cloudflare
- [x] **Phase 19: Confianza, medición y seguridad** - Contenido propio en los hubs, fuentes médicas citadas, informe de GSC sin partir y CSP
...
**Requirements**: CWV-01, CWV-02, CWV-03, CWV-04, A11Y-01 (CWV-05 salió del alcance el 2026-08-24 y se resolvió aparte el 2026-08-26, en el PR #22)
...
**Success Criteria** (qué debe ser TRUE):
  ...
  4. El bundle compartido arrastra menos de 15 KB de JavaScript sin usar y no sirve polyfills legacy a navegadores que no los necesitan. (El peso de `/opengraph-image` salió de este criterio el 2026-08-24 y se resolvió el 2026-08-26 fuera de la fase, en el PR #22: las tarjetas pasaron de PNG a JPEG pregenerado, de 551 KB a 56 KB.)
...
- [x] 18-01-PLAN.md — A11Y-01: contraste de la portada, `<dl>` de `/agendar` y orden de encabezados de `/sedes`
- [ ] 18-02-PLAN.md — CWV-01: diagnóstico cerrado y regla escrita en `18-CLOUDFLARE-CACHE.md`. La tarea 2 la aplica Juan en el panel de Cloudflare y la tarea 3 mide el cierre, hoy automatizada en `npm run cache:check -- --gate`
- [x] 18-03-PLAN.md — CWV-02: perfilado y arreglo de `/testimonios`
- [x] 18-04-PLAN.md — CWV-03: LCP de `/sobre-el-doctor`
- [x] 18-05-PLAN.md — CWV-04: la capa editorial fuera del cliente
...
| 17. Indexación y enlaces de entrada | v1.3 | 0/TBD | Not started, material preparado | - |
| 18. Rendimiento y accesibilidad | v1.3 | 4/5 | In Progress, falta CWV-01 en el panel de Cloudflare | - |
| 19. Confianza, medición y seguridad | v1.3 | 4/4 | Complete | 2026-08-25, PR #21 |
