...
Phase: 10, schema y metadata. Reabierta para cerrar SEO-08 con el paquete on-page de v1.2 (planes 10-01 y 10-02)
Plan: 10-01 cerrado. Las 9 rutas base con metadata estática sirven el title y la meta del paquete, y el layout raíz ya no hereda la description larga de `siteConfig`. Falta 10-02, que hace lo mismo con las 13 rutas de contenido dinámico (servicios, sedes y blog)
Status: Fase 10 en curso, 1 de 2 planes cerrados
Last activity: 2026-08-13, plan 10-01 ejecutado (title y meta del paquete en las 9 rutas base, `title: { absolute }` para que el template del layout no pegue el sufijo, tarjetas OG revisadas a ojo)
